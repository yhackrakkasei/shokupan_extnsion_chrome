...
var $question_title  = $('<div/>').css({
    ...
    '<dd id="shokupan_q_title" style="font-size: 26px; margin-left: 60px;"></dd>'+
    '</dl>');
var $question_select = $('<div/>').css({
    "widht"  : "390px",
    "height" : "250px"
}).html('<input type="radio" name="q" value="1">学生証<br>'+
    '<input type="radio" name="q" value="2">定期券<br>'+
    '<input type="radio" name="q" value="3">携帯<br>'+
...
var $video_reunion_m = $('<video id="shokupan_video_reunion_m" width="640" height="480"><source src="chrome-extension://gjncemgkdjhpofeiaclefaegbpkefimk/movie/reunion_m.webm" type="video/webm; codecs=&quot;vorbis,vp8&quot;"></video>');
var $video_reunion_f = $('<video id="shokupan_video_reunion_f" width="640" height="480"><source src="chrome-extension://gjncemgkdjhpofeiaclefaegbpkefimk/movie/reunion_f.webm" type="video/webm; codecs=&quot;vorbis,vp8&quot;"></video>');
...
var reunion = function(){
    ...
    if (gender === 'male') {
        $mask_content.append($video_reunion_m);
        document.getElementById('shokupan_video_reunion_m').play();
    } else {
        $mask_content.append($video_reunion_f);
        document.getElementById('shokupan_video_reunion_f').play();
    }
};
