...
var $question = $('<div/>').css({
    "width"  : "480px",
    "height" : "480px"
}).html('<input type="radio" name="q" value="1">てすと１<input type="radio" name="q" value="2">てすと2<br><input type="radio" name="q" value="3">てすと3<br><button id="submit">送信</button>');
...
var $video = $('<video id="shokupan_video" width="640" height="480"><source src="http://www.gomplayer.jp/img/sample/mp4_h264_aac.mp4" type="video/webm; codecs=&quot;vorbis,vp8&quot;"></video>');
